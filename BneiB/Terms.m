...
- (void)viewDidLoad
{
    ...
    [TestFlight passCheckpoint:@"EC Terms load"];
...
- (void)actionSheet: (UIActionSheet *) actionSheet clickedButtonAtIndex:(NSInteger)buttonIndex{
        ...
        if ([MFMailComposeViewController canSendMail]) {
            ...
            [composer setMessageBody:@"Terms of Use, Bnei Baruch.  http://goo.gl/rjBNJ \n Via Kabbalah App" isHTML:YES];
            [composer setModalTransitionStyle:UIModalTransitionStyleCoverVertical];
            [self presentViewController:composer animated:YES completion:nil];
        }
        [TestFlight passCheckpoint:@"Email Terms"];
    }
    ...
    if (buttonIndex == 1) {
        ...
        [TestFlight passCheckpoint:@"Open in Safari. Terms"];
    }
