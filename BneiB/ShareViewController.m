...
//  Kabbalah
//
//  Created by Rockstar. on 8/28/12.
...
- (void)viewDidLoad
{
    ...
    [[NSMutableDictionary alloc] initWithObjectsAndKeys:
     @"http://tv.kabbalah.info", @"link",
     @"http://i1051.photobucket.com/albums/s422/kabbalahapp/9d00fa7b.png", @"picture",
     @"Kabbalah Channel", @"name",
     @"Watch life makes sense.", @"caption",
     @"All of the programming you’ll see on the Kabbalah Channel is about the natural meaning and purpose of life and how you can fulfill it.", @"description",
     nil];
