...
NSString *const kPlaceholderSStudyPostMessage = @"Say something about this...";

@interface StudyShareViewController ()
...
@implementation StudyShareViewController
...
{
    self.postMessageTextView.text = kPlaceholderSStudyPostMessage;
...
- (void)textViewDidBeginEditing:(UITextView *)textView
{
    ...
    if ([textView.text isEqualToString:kPlaceholderSStudyPostMessage]) {
        textView.text = @"";
...
- (void)viewDidLoad
{
    ...
    [[NSMutableDictionary alloc] initWithObjectsAndKeys:
     @"http://www.kabbalahbooks.info", @"link",
     ...
     @"The Kabbalah Books of Zohar, Kabbalah for beginners, Music, DVDs", @"description",
     nil];
...
- (IBAction)shareButtonAction:(id)sender {
    ...
    if (![self.postMessageTextView.text
          isEqualToString:kPlaceholderSStudyPostMessage] &&
